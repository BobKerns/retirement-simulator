...
describe("Actuary", () => {
    ...
    const january = UTC(2022, 0, 1);
    const july = UTC(2022, 6, 3); // Midyear
    ...
    test("person male interpolate", () => expect(roundDatum(actuary(person_2, july))).toEqual({n: 88998, p: 0.008, years: 25.1}));
